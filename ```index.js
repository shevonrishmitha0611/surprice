...
export function App() {
  ...
  useEffect(() => {
    const audio = new Audio(
      'https://www.chosic.com/wp-content/uploads/2021/04/romantic-piano-extended-version-2868.mp3',
    )
    audio.loop = true
  ...
  return (
    <div className="w-full min-h-screen bg-gradient-to-b from-pink-50 to-pink-100 overflow-x-hidden">
      {/* Floating hearts background */}
      <FloatingHearts />
      {/* Music control button */}
      <button
        onClick={togglePlay}
        className="fixed bottom-4 right-4 z-50 bg-pink-200 hover:bg-pink-300 rounded-full p-3 shadow-lg transition-all duration-300"
      >
        {isPlaying ? (
          <VolumeXIcon size={20} color="#d53f8c" />
        ) : (
          <Music2Icon size={20} color="#d53f8c" />
        )}
      </button>
      {/* Hero Section */}
      <HeroSection />
...
const HeroSection = () => {
  return (
    ...
    >
      <Sparkles>
        <motion.h1
          className="text-4xl md:text-6xl font-bold text-center text-pink-600 mb-6"
          initial={{
            scale: 0.8,
          }}
          animate={{
...
const ReasonsSection = () => {
  ...
  return (
    <section className="min-h-screen py-20 px-4 md:px-10 bg-gradient-to-b from-pink-100 to-pink-50 relative">
      <div className="max-w-3xl mx-auto">
        <motion.h2
          className="text-3xl md:text-4xl font-bold text-center text-pink-600 mb-16"
          initial={{
            opacity: 0,
            y: 20,
          }}
        ...
        <div className="space-y-10">
          {reasons.map((reason, index) => (
            <motion.div
              key={index}
              className="bg-white/70 backdrop-blur-sm p-6 rounded-lg shadow-lg border border-pink-200"
              initial={{
                opacity: 0,
                x: index % 2 === 0 ? -50 : 50,
              }}
...
const GallerySection = () => {
  ...
  const photos = [
    '<img src="\Users\HP\Downloads\website\images\IMG-20250406-WA0003.jpg.">=rb-1.2.1&auto=format&fit=crop&w=500&q=80',
    'c:\Users\HP\Downloads\website\images\IMG-20250325-WA0000.jpg. ">=rb-1.2.1&auto=format&fit=crop&w=500&q=80',
    'c:\Users\HP\Downloads\website\images\IMG-20250325-WA0001.jpg. ">=rb-1.2.1&auto=format&fit=crop&w=500&q=80',
  ]
  return (
    <section className="py-20 px-4 md:px-10 bg-gradient-to-b from-pink-50 to-pink-100">
      <div className="max-w-6xl mx-auto">
        <motion.h2
          className="text-3xl md:text-4xl font-bold text-center text-pink-600 mb-10"
          initial={{
            opacity: 0,
            y: 20,
          }}
...
const LoveLetterSection = () => {
  return (
    <section className="min-h-screen py-20 px-4 md:px-10 bg-gradient-to-b from-pink-100 to-pink-50 flex items-center justify-center">
      <motion.div
        className="max-w-2xl mx-auto bg-white/80 backdrop-blur-sm p-8 md:p-12 rounded-xl shadow-xl border border-pink-200"
        initial={{
          opacity: 0,
          y: 50,
        }}
      ...
      >
        ...
        <div className="space-y-6 text-pink-800">
          ...
          <p>
            ...
            deeply. Your smile, your kindness - everything about you
            makes my heart fuller each day.
          </p>
          <p>
          ...
          <p className="text-right font-bold">Me</p>
        </div>
      </motion.div>
    </section>
  )
